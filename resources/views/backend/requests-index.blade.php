        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 col-sm-8 col-12">
                <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                    ...
                    <li class="active breadcrumb-item">Requests</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div>
                    <div>
                        <table class="table  table-striped table-bordered table-hover dataTable no-footer"
                            ...
                            <thead>
                                <tr role="row">
                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Date</th>
                                    ...
                                    <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Message</th>
                                    <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Property</th>
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>{{ $value->contact }}</td>
                                    <td>{{  $value->message }}</td>
                                    <td>{{  $value->property->landlord->name }}</td>
