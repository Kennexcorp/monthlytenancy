    ...
    <div class="container">
        <div class="row align-items-stretch">
            ...
            <div class="col-lg-5 ml-auto">
                ...
                <p class="mb-5">The Monthly Tenancy Plan, is a property tech company, aimed at bridging the tenancy gap in Nigeria by providing alternative to yearly Tenancy. The monthly tenancy plan is designed to improve
